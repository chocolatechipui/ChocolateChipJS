...
test('[].bind:', function() {
   ...
   equal($.chch_cache.events.keys.length, 1, 'Should be an array.');
   equal($.chch_cache.events.keys.indexOf('listitem'), -1, 'Should return id of "listitem".');
